...
VALUES ('Happy', 'happy@example.com', '82229333', '{bcrypt}$2a$12$6JlEZRQfifnYvHIynno4X.a7maSU16z9yLGKR.CF7../7mEh1saSK', 'admin,', CURDATE());
...
(UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 7 DAY), 'Coffee Shop', 'Withdrawal', 30,34500,DATE_SUB(CURDATE(), INTERVAL 7 DAY)),
(UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 6 DAY), 'Uber', 'Withdrawal', 100,34400,DATE_SUB(CURDATE(), INTERVAL 6 DAY)),
(UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 5 DAY), 'Self Deposit', 'Deposit', 500,34900,DATE_SUB(CURDATE(), INTERVAL 5 DAY)),
(UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 4 DAY), 'Ebay', 'Withdrawal', 600,34300,DATE_SUB(CURDATE(), INTERVAL 4 DAY)),
(UUID(), 1865764534, 1, DATE_SUB(CURDATE(), INTERVAL 1 DAY), 'Amazon.com', 'Withdrawal', 100,34900,DATE_SUB(CURDATE(), INTERVAL 1 DAY));
...
SELECT * FROM eazybank.customer;
SELECT * FROM eazybank.accounts;
SELECT * FROM eazybank.account_transactions;
SELECT * FROM eazybank.loans;
SELECT * FROM eazybank.cards;
SELECT * FROM eazybank.notice_details;
SELECT * FROM eazybank.contact_messages;
